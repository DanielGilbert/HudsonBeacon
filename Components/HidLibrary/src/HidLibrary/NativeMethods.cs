...
namespace HidLibrary
{
    internal static class NativeMethods
    {
        ...
        internal static extern Boolean HidD_GetSerialNumberString(IntPtr HidDeviceObject, Byte[] StringBuffer, Int32 StringBufferLength);

        [DllImport("hid.dll", SetLastError = true)]
        internal static extern Boolean HidD_GetIndexedString(IntPtr HidDeviceObject, Int32 StringIdex, Byte[] StringBuffer, Int32 StringBufferLength);
    }
}
